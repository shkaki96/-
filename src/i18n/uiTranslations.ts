...
export const UI_TRANSLATIONS: Record<Language, UITranslationSchema> = {
  ...
  bad: {
    app: {
      title: 'تاق - TAQ',
      subtitle: 'تاقیگەها فیزیکێ یا هێماییکری (سیمیولەیشن)',
      tagline: 'پلاتفۆرما کارلێککەر یا سیمیولەیشن و تاقیکرنێن فیزیکێ یێن پەروەردەیی',
      version: 'کاکل ۱.۰.۰ (بنیاتێ ئەندازیاری)',
    },
    nav: {
      home: 'سەرەکی',
      experiments: 'تاقیکرن',
      categories: 'پشک و پول',
      search: 'لێگەریان',
      favorites: 'یێن دڵخواز',
      settings: 'رێکخستن',
      about: 'دەربارەی تاقیگەهێ',
    },
    simulation: {
      controls: 'ئامیرێن کۆنترۆلێ',
      start: 'دەستپێکرن',
      pause: 'راوەستاندنا دەمکی',
      reset: 'زڤڕاندن بۆ باری دەستپێکێ',
      parameters: 'پێوەرێن فیزیکی (پارامیتەر)',
      results: 'ئەنجامێن راستەوخۆ',
      realTimeMetrics: 'پێڤانێن دەستبەجێ',
      fullscreen: 'شاشەیا تژی',
      stateReady: 'ئامادەیە (READY)',
      stateRunning: 'د لڤینێ دایە (RUNNING)',
      statePaused: 'راوەستایە (PAUSED)',
    },
    experiment: {
      details: 'هویرکاریێن تاقیکرنێ',
      theory: 'بیردۆز و یاسا',
      howItWorks: 'چەوا کار دکەت',
      whatHappened: 'چ رویدا د سیمیولەیشنێ دا',
      result: 'ئەنجام و دەرئەنجام',
      procedure: 'پێنگاڤێن تاقیکرنێ',
      physicalLaw: 'یاسایا فیزیکی',
      inputs: 'متغیرێن دەستپێکێ (هاتنەژوور)',
      outputs: 'دەرکەفتی و پێڤان',
      runSimulation: 'دەستپێکرنا سیمیولەیشنێ',
      next: 'تاقیکرنا پاشتر',
      previous: 'تاقیکرنا پێشتر',
      allExperiments: 'هەمی تاقیکرن',
    },
    categories: {
      mechanics: 'میکانیک',
      electricity: 'کارەب و موگناتیسی',
      waves: 'پێل و دەنگ',
      thermodynamics: 'تێرمۆدینامیک (گەرمی)',
      optics: 'بینایی و رووناهی',
      modern_physics: 'فیزیکا سەردەم و ناڤۆکی',
    },
    common: {
      language: 'زمان',
      selectLanguage: 'زمانێ هەلبژێرە',
      theme: 'شێواز (تێم)',
      securityNotice: 'سیستەم پاراستییە بۆ پاراستنا زانیاریان',
      loading: 'تێتە بارکرن...',
      error: 'شاشیەک رویدا',
      noResults: 'چ ئەنجام نەهاتنە دیتن',
    },
    ads: {
      sponsored: 'سپۆنسەرێ پەروەردەیی',
      educationalPartner: 'هەڤپشکێ زانستی و پەروەردەیی',
      close: 'داخستنا رێکلامێ',
      nonIntrusiveNotice: 'رێکلاما بێ ئاستەنگ بۆ پشتەڤانیا پەروەردەیا فیزیکێ یا بێبەرامبەر',
    },
    drawer: {
      science: 'زانست',
      physics: 'فیزیک و تاقیکرن',
      futureSubjects: 'بابەتێن پاشەرۆژێ',
      chemistry: 'کیمیا',
      mathematics: 'بیرکاری (ماتماتیک)',
      astronomy: 'گەردوونناسی و ئەستێرەناسی',
      comingSoon: 'ب زویاتی دێ هێت',
      tools: 'ئامیرێن تاقیگەهێ',
      scientificKeyboard: 'تەختەکلیلێ زانستی',
      labNotebook: 'دەفتەرا تاقیگەهێ',
      tests: 'تاقیکرنێن زانستی (پسیار)',
      symbolsAndConstants: 'هێما و نەگۆڕێن فیزیکی',
      formulas: 'رێبەریێ یاسا و هاوکێشەیان',
    },
    theoryModal: {
      title: 'شیکاریا زانستی و بیردۆز',
      objective: 'ئارمانجا تاقیکرنێ',
      whatHappened: 'چ رویدا د تاقیکرنێ دا',
      theoreticalExplanation: 'شیکرنەڤەیا بیردۆزی',
      howItWorks: 'چەوا کار دکەت',
      physicalLaw: 'یاسایا فیزیکی',
      observations: 'تێبینیێن زانستی',
      obtainedResults: 'ئەنجامێن دەستکەفتی',
      conclusion: 'دەرئەنجام',
    },
    tools: {
      scientificKeyboardTitle: 'ژمێرەر و تەختەکلیلێ زانستی',
      labNotebookTitle: 'دەفتەرا تێبینیان',
      testsTitle: 'تاقیکرنا تێگەهشتنێ (کویز)',
      symbolsTitle: 'نەگۆڕێن فیزیکی یێن گەردوونی',
      formulasTitle: 'رێبەریێ یاسا و هاوکێشەیان',
      typeNoteHere: 'تێبینیێن تاقیکرنا خۆ ل ڤێرێ بنڤیسە...',
      saveNote: 'تۆمارکرنا تێبینیێ',
      clearNotes: 'پاقژکرنا تێبینیان',
      recordDataPoint: 'تۆمارکرنا داتایا پێڤانێ',
      searchConstants: 'ل نەگۆڕەکی بگەڕە...',
      searchFormulas: 'ل یاسایەکێ بگەڕە...',
      score: 'نمرە',
      question: 'پسیار',
      nextQuestion: 'پسیارا پاشتر',
      checkAnswer: 'پشکنینا بەرسڤێ',
      correct: 'بەرسڤا دروستە!',
      incorrect: 'بەرسڤا شاشە، جارەکا دی هەول بدە.',
      explanation: 'شیکرنەڤەیا زانستی',
    },
  },
};
